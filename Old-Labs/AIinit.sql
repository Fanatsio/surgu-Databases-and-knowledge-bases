...
CREATE TABLE zakaz (
    ...
    customer_type VARCHAR(10) CHECK (customer_type IN ('fiz', 'yur')),
    total_cost DECIMAL(10,2) NOT NULL,
    order_date DATE NOT NULL,
    customer_id INTEGER,
    CONSTRAINT fk_customer FOREIGN KEY (customer_id, customer_type) REFERENCES fiz_lico(id, 'fiz') ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_customer FOREIGN KEY (customer_id, customer_type) REFERENCES yur_lico(id, 'yur') ON DELETE SET NULL ON UPDATE CASCADE
);
